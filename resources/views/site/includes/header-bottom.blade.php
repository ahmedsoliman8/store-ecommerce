                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                ...
                                <ul class="menu level1">
                                    ...
                                    @isset($categories)
                                        @foreach($categories as $category)
                                            ...
                                            <li class="item  {{count($category -> childrenCategories)>0?"parent":""}}">
                                                    ...
                                                    <div class="dropdown-menu" style="width:222px">
                                                        <ul>
                                                            ...
                                                            @foreach($category -> childrenCategories  as $childern)
                                                                @include('site.includes.child_category',['childern'=>$childern])
                                                                {{--
                                                                <li class="item ">
                                ...
                                <ul class="menu level1">
                                    ...
                                    <li class="item  parent"><a href="#" title="Laptops &amp; Accessories"><i
                                           ...
                                           </a><span class="show-sub fa-active-sub"></span><span
