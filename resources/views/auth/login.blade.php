...
<body id="index" class="{{getFolder()==="css-rtl"?"lang-ar lang-rtl ":""}}country-gb currency-gbp layout-full-width page-index tax-display-enabled">
                                        ...
                                        <div class="form-group row no-gutters">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group js-parent-focus">
                                                    <input  id="password" type="password" class="form-control js-child-focus js-visible-password @error('password') is-invalid @enderror" name="password" required autocomplete="current-password"    pattern=".{5,}" >
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-10 offset-md-2">
                                    <div class="no-account">
                                        <a href="http://demo.bestprestashoptheme.com/savemart/ar/تسجيل الدخول?create_account=1" data-link-action="display-register-form">
