                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.products.update',$product->id)}}"
                                            ...
                                            <div class="tab-content">
                                                @include('dashboard.products.update.tabs.product_info')
                                                @include('dashboard.products.update.tabs.product_other_info')
                                                @include('dashboard.products.update.tabs.category_id')
                                            </div>
                                            <hr/>
